...
import kaa_metadata.video.core as video
import kaa_metadata.audio.core as audio

# kaa_metadata.disc imports
import core
try:
    import _ifoparser
except ImportError:
...
class DVDInfo(core.Disc):
    ...
    def _parse(self, device):
        if not _ifoparser:
            log.debug("kaa_metadata not compiled with DVD support")
